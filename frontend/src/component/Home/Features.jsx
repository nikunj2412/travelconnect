...
<div class="flex-wrap  items-center justify-end gap-4 sm:flex">
    <div class="w-full text-center px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 ">
        <div class="flex-shrink-0">
            <div class="flex items-center justify-center w-12 h-12 mx-auto bg-orange-400 rounded-md">
                <GrPlan className="text-white"/>
            </div>
        </div>
        <h3 class="py-4 font-semibold text-gray-700 text-xl ">
            Plan Your Trip
        </h3>
    ...
    <div class="w-full text-center px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4">
        <div class="flex-shrink-0">
            <div class="flex items-center justify-center w-12 h-12 mx-auto text-white bg-orange-400 rounded-md">
            <MdTravelExplore/>
            </div>
        </div>
        <h3 class="py-4 text-xl font-semibold text-gray-700 ">
    ...
    <div class="w-full px-4 py-4 text-center mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 ">
        <div class="flex-shrink-0">
            <div class="flex items-center justify-center w-12 h-12 mx-auto text-white bg-orange-400 rounded-md">
                <FaRoute/>
            </div>
